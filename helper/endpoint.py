...
required_fields = {
    ...
    'item_validated/update_bulk': [ 'modified_by', 'item_id[]' ],
    'item_validated/delete': [ 'deleted_by' ],
    'item_validated/delete_bulk': [ 'deleted_by', 'item_id[]' ],
    ...
    'orderitem/create': [ 'item_id', 'quantity', 'added_by' ],
    'orderitem/update': [ 'modified_by' ],
    'orderitem/delete': [ 'deleted_by' ],
...
modifiable_fields = {
    ...
    'item_validated/update_bulk': [ 'brand[]', 'name[]', 'variant[]', 'base_price[]', 'category_id[]', 'qty_unit_id[]' ],
